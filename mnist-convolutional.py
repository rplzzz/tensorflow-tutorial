...
Wconv1 = wgtvar([5,5,1,32], name="wgt-conv-1")
...
bconv1 = bvar([32], name="bias-conv-1")
...
ximg = tf.reshape(x, [-1, 28, 28, 1], name="input-images")
...
## of this layer.
hconv1 = tf.nn.relu(conv2d(ximg, Wconv1, name="conv1") + bconv1, name="hconv1")
hpool1 = maxpool2x2(hconv1, name="hpool1")
...
Wconv2 = wgtvar([5,5,32,64], name="wgt-conv-2")
bconv2 = bvar([64], name="bias-conv-2")

hconv2 = tf.nn.relu(conv2d(hpool1, Wconv2) + bconv2, name="hconv2")
hpool2 = maxpool2x2(hconv2, name="hpool2")
...
imglen = 7*7*64
Wfc1 = wgtvar([imglen, 1024], name="wgt-fc-1")
bfc1 = bvar([1024], name="bias-fc-1")

hpool2f = tf.reshape(hpool2, [-1, imglen], name="hpool2-flattened")
## as usual, we have to multiply the input from the left because we store
## samples in rows.
hfc1 = tf.nn.relu(tf.matmul(hpool2f, Wfc1) + bfc1, name="hfc1")
...
Wfc2 = wgtvar([1024,10], name="wgt-fc2")
bfc2 = bvar([10], name="bias-fc2")
